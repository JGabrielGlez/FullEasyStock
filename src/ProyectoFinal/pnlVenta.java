...
public class pnlVenta extends controladorPanel {
    ...
    private void initComponents() {
        ...
        cboTipoPago.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Tipo de pago", "Efectivo", "Tarjeta de crédito", "Tarjeta de débito" }));
        pnlTotal.add(cboTipoPago, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 58, -1, -1));
